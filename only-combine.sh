...
REF_WORK_DIR_PATH="${HOME}/work/ubuntu-iso-builder-import-pacstall-mate-theme-graphite"
...
echo "[Next Step]: cd ~/work/ubuntu-iso-builder-import-pacstall-mate-theme-graphite/iso-profile
"
echo
